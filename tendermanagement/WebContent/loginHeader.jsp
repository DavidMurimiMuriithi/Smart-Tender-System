...
<html lang="en">
  <head>
    <link rel="shortcut icon" type="image/png" href="images/kabarak logo.png">
        ...
        <div class="container" >
            <div class="navbar-header"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    <img src="images/kabarak logo.png" alt="HIT Haldia" width="70px" height="70px"/>
                </a>
                    <a class="navbar-brand" href="#"><h1>Smart Tender System</h1></a> <!-- Library Name fixed-->
                    <a href="#"><p> Research Project</p></a>
            </div>
