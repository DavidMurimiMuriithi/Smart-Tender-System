...
<html lang="en">
  <head>
    <link rel="shortcut icon" type="image/png" href="images/Bid Color.png">
...
<form action="UploadTenderDocument" method="post" enctype="multipart/form-data">
   <div class="form-group"> 
   <label for="tenderFile">Select Tender Document (PDF/Word):</label>
    <input type="file" name="tenderFile" id="tenderFile" accept=".pdf, .doc, .docx" required>
    <br><br></div>
  
    <div class="form-group"><input type="submit" value="Upload Document"></div>
</form>
 <hr>
